...
const Hero: React.FC = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-start items-center px-6 relative overflow-hidden pt-32 pb-24">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div className={`flex flex-col sm:flex-row items-center justify-center gap-4 mt-8 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-8'}`}>
          <a 
            href="#services" 
      ...
      {/* Scroll indicator - moved up to be closer to the content */}
      <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 flex flex-col items-center opacity-60 hover:opacity-100 transition-opacity">
